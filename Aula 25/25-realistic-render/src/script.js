...
directionalLight.shadow.bias = - 0.014
...
const floorAORughnessMetalnessTexture = textureLoader.load('/textures/wood_cabinet_worn_long/wood_cabinet_worn_long_arm_1k.jpg')
...
const floor = new THREE.Mesh(
    ...
    new THREE.MeshStandardMaterial({
        ...
        aoMap: floorAORughnessMetalnessTexture,
        roughnessMap: floorAORughnessMetalnessTexture,
        metalnessMap: floorAORughnessMetalnessTexture,
    })
)
...
const wallAORughnessMetalnessTexture = textureLoader.load('/textures/castle_brick_broken_06/castle_brick_broken_06_arm_1k.jpg')
...
const wall = new THREE.Mesh(
    ...
    new THREE.MeshStandardMaterial({
        ...
        aoMap: wallAORughnessMetalnessTexture,
        roughnessMap: wallAORughnessMetalnessTexture,
        metalnessMap: wallAORughnessMetalnessTexture,
    })
)
wall.position.y = 4
wall.position.z = - 4
