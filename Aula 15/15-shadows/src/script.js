...
//Spot Light
const spotLight = new THREE.SpotLight(0xffffff, 5, 10, Math.PI * 0.25)

spotLight.castShadow = true
spotLight.shadow.mapSize.width = 1024
spotLight.shadow.mapSize.height = 1024
// spotLight.shadow.camera.fov = 30  // Changing the value of the fov dont work anymore
spotLight.shadow.camera.near = 1
spotLight.shadow.camera.far = 6


spotLight.position.set(3.5, 1, 0)
scene.add(spotLight)
