...
`)a=0,l-=s;else{const u=jm(h,r,a,l,e);a+=u.offsetX,o.push(u.path)}}return o}function jm(i,t,e,n,r){const s=r.glyphs[i]||r.glyphs["?"];if(!s){console.error('THREE.Font: character "'+i+'" does not exists in font family '+r.familyName+".");return}const o=new Um;let a,l,c,h,u,f,m,g;if(s.o){const x=s._cachedOutline||(s._cachedOutline=s.o.split(" "));for(let p=0,d=x.length;p<d;)switch(x[p++]){case"m":a=x[p++]*t+e,l=x[p++]*t+n,o.moveTo(a,l);break;case"l":a=x[p++]*t+e,l=x[p++]*t+n,o.lineTo(a,l);break;case"q":c=x[p++]*t+e,h=x[p++]*t+n,u=x[p++]*t+e,f=x[p++]*t+n,o.quadraticCurveTo(u,f,c,h);break;case"b":c=x[p++]*t+e,h=x[p++]*t+n,u=x[p++]*t+e,f=x[p++]*t+n,m=x[p++]*t+e,g=x[p++]*t+n,o.bezierCurveTo(u,f,m,g,c,h);break}}return{offsetX:s.ha*t,path:o}}class Qm extends po{constructor(t,e={}){const n=e.font;if(n===void 0)super();else{const r=n.generateShapes(t,e.size);e.depth===void 0&&e.height!==void 0&&console.warn("THREE.TextGeometry: .height is now depreciated. Please use .depth instead"),e.depth=e.depth!==void 0?e.depth:e.height!==void 0?e.height:50,e.bevelThickness===void 0&&(e.bevelThickness=10),e.bevelSize===void 0&&(e.bevelSize=8),e.bevelEnabled===void 0&&(e.bevelEnabled=!1),super(r,e)}this.type="TextGeometry"}}new go;const gl=document.querySelector("canvas.webgl"),Pr=new qp,tg=new Dm,_l=tg.load("/textures/matcaps/8.png");_l.colorSpace=Ne;const eg=new Km;eg.load("/fonts/helvetiker_regular.typeface.json",i=>{const t=new Qm("Igor Galvao",{font:i,size:.5,depth:.2,curveSegments:6,bevelEnabled:!0,bevelThickness:.03,bevelSize:.02,bevelOffset:0,bevelSegments:5});t.center();const e=new Tm({matcap:_l}),n=new Be(t,e);Pr.add(n);const r=new mo(.3,.2,20,45);for(let s=0;s<100;s++){const o=new Be(r,e);o.position.x=(Math.random()-.5)*10,o.position.y=(Math.random()-.5)*10,o.position.z=(Math.random()-.5)*10,o.rotation.x=Math.random()*Math.PI,o.rotation.y=Math.random()*Math.PI;const a=Math.random();o.scale.set(a,a,a),Pr.add(o)}});const He={width:window.innerWidth,height:window.innerHeight};window.addEventListener("resize",()=>{He.width=window.innerWidth,He.height=window.innerHeight,Mn.aspect=He.width/He.height,Mn.updateProjectionMatrix(),Oi.setSize(He.width,He.height),Oi.setPixelRatio(Math.min(window.devicePixelRatio,2))});const Mn=new Ce(75,He.width/He.height,.1,100);Mn.position.x=1;Mn.position.y=1;Mn.position.z=2;Pr.add(Mn);const vl=new Om(Mn,gl);vl.enableDamping=!0;const Oi=new Yp({canvas:gl});Oi.setSize(He.width,He.height);Oi.setPixelRatio(Math.min(window.devicePixelRatio,2));const ng=new Im,xl=()=>{ng.getElapsedTime(),vl.update(),Oi.render(Pr,Mn),window.requestAnimationFrame(xl)};xl();
//# sourceMappingURL=index-zEyDp0Hl.js.map
